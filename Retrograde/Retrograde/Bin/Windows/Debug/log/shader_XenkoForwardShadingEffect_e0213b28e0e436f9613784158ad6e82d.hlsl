...
@C    scale_id183 => Material.TextureScale.i1
@C    offset_id184 => Material.TextureOffset.i1
@C    constantFloat_id186 => Material.SpecularIntensityValue
...
@R    Sampler_id173 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Texture_id181 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
@R    Texture_id181 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id181 => Material.SpecularMap [Stage: Pixel, Slot: (1-1)]
...
//
#line 776 "G:\Documents\Xenko Projects\Retrograde\Retrograde\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_e0213b28e0e436f9613784158ad6e82d.hlsl"
...
@G    Pixel => f1278d409d03c45cbe189dbae18ef102
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id183;                // Offset:   16 Size:     8
//   float2 offset_id184;               // Offset:   24 Size:     8
//   float constantFloat_id186;         // Offset:   32 Size:     4
//
// }
//
// cbuffer PerView
...
// Texture_id181                     texture  float4          2d    1        1
...
//
#line 805 "G:\Documents\Xenko Projects\Retrograde\Retrograde\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_e0213b28e0e436f9613784158ad6e82d.hlsl"
...
sample r2.xyzw, r2.xyxx, t0.xyzw, s1  // r2.x <- <Compute_id234 return value>.x; r2.y <- <Compute_id234 return value>.y; r2.z <- <Compute_id234 return value>.z; r2.w <- <Compute_id234 return value>.w

#line 591
mad r3.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample r3.xyzw, r3.xyxx, t1.xyzw, s1  // r3.x <- <Compute_id236 return value>.x; r3.y <- <Compute_id236 return value>.y; r3.z <- <Compute_id236 return value>.z

#line 566
mul r3.xyz, r3.xyzx, cb0[2].xxxx  // r3.x <- streams.matSpecularVisible_id64.x; r3.y <- streams.matSpecularVisible_id64.y; r3.z <- streams.matSpecularVisible_id64.z
...
mov r5.w, l(0)
ld r4.xyzw, r5.xyzw, t2.xyzw  // r4.x <- streams.lightData_id83.x; r4.y <- streams.lightData_id83.y

#line 556
and r1.w, r4.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id207 return value>
...
#line 440
  ld r12.xyzw, r10.xxxx, t3.xyzw  // r12.x <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id84
  ishl r4.z, r12.x, l(1)
  ld r12.xyzw, r4.zzzz, t4.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  iadd r4.z, r4.z, l(1)
  ld r13.xyzw, r4.zzzz, t4.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 206
  ...
  mul r4.z, r4.z, r4.z  // r4.z <- <SmoothDistanceAttenuation_id72 return value>
...
#line 269
  ...
  mul r6.x, r6.x, r6.x
  mul r4.w, r4.w, r6.x
  mad r14.xyz, r14.xyzx, r4.wwww, r9.yzwy  // r14.x <- <FresnelSchlick_id155 return value>.x; r14.y <- <FresnelSchlick_id155 return value>.y; r14.z <- <FresnelSchlick_id155 return value>.z

#line 265
  mad r4.w, r4.z, l(0.500000), l(0.500000)
  div r4.w, r4.z, r4.w  // r4.w <- <VisibilityhSchlickGGX_id173 return value>
  mad r6.x, r10.z, l(0.500000), l(0.500000)
  div r6.x, r10.z, r6.x  // r6.x <- <VisibilityhSchlickGGX_id173 return value>

#line 316
  mul r4.w, r4.w, r6.x
  mul r4.z, r10.z, r4.z
  div r4.z, r4.w, r4.z  // r4.z <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 517
ushr r1.w, r4.y, l(16)  // r1.w <- <GetMaxLightCount_id216 return value>
...
#line 409
  ld r12.xyzw, r6.wwww, t3.xyzw  // r12.x <- realLightIndex
  iadd r6.w, r6.w, l(1)  // r6.w <- streams.lightIndex_id84
  ishl r8.w, r12.x, l(2)
  ld r12.xyzw, r8.wwww, t5.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z

#line 415
  iadd r10.yzw, r8.wwww, l(0, 1, 2, 3)
  ld r13.xyzw, r10.yyyy, t5.xyzw  // r13.x <- spotLight2.x; r13.y <- spotLight2.y; r13.z <- spotLight2.z
  ld r14.xyzw, r10.zzzz, t5.xyzw  // r14.x <- spotLight3.x; r14.y <- spotLight3.y; r14.z <- spotLight3.z
  ld r15.xyzw, r10.wwww, t5.xyzw  // r15.x <- spotLight4.x; r15.y <- spotLight4.y; r15.z <- spotLight4.z

#line 296
  mov r5.x, r4.w
  add r10.yzw, -r5.xxyz, r12.xxyz  // r10.y <- lightVector.x; r10.z <- lightVector.y; r10.w <- lightVector.z
  dp3 r5.x, r10.yzwy, r10.yzwy
  sqrt r8.w, r5.x  // r8.w <- lightVectorLength
  div r10.yzw, r10.yyzw, r8.wwww  // r10.y <- lightVectorNorm.x; r10.z <- lightVectorNorm.y; r10.w <- lightVectorNorm.z

#line 258
  max r8.w, r5.x, l(0.000100)
  div r8.w, l(1.000000, 1.000000, 1.000000, 1.000000), r8.w  // r8.w <- attenuation

#line 200
  mul r5.x, r14.z, r5.x  // r5.x <- factor
...
#line 259
  mul r5.x, r5.x, r8.w  // r5.x <- attenuation

#line 250
  dp3 r8.w, -r13.xyzx, r10.yzwy  // r8.w <- cd
...
#line 538
  ...
  dp3 r6.x, r10.yzwy, r13.xyzx
  max r6.x, r6.x, l(0.000100)  // r6.x <- streams.LdotH_id70

#line 534
  mul r10.yzw, r7.xxyz, r12.xxyz
...
#line 269
  ...
  mul r8.w, r8.w, r8.w
  mul r6.x, r6.x, r8.w
  mad r13.xyz, r13.xyzx, r6.xxxx, r8.xyzx  // r13.x <- <FresnelSchlick_id155 return value>.x; r13.y <- <FresnelSchlick_id155 return value>.y; r13.z <- <FresnelSchlick_id155 return value>.z

#line 265
  mad r6.x, r5.x, l(0.500000), l(0.500000)
  div r6.x, r5.x, r6.x  // r6.x <- <VisibilityhSchlickGGX_id173 return value>
  mad r8.w, r3.w, l(0.500000), l(0.500000)
  div r8.w, r3.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id173 return value>

#line 316
  mul r6.x, r6.x, r8.w
  mul r5.x, r3.w, r5.x
  div r5.x, r6.x, r5.x  // r5.x <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 652
  mad r9.xyz, r12.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r10.yzwy  // r9.x <- directLightingContribution.x; r9.y <- directLightingContribution.y; r9.z <- directLightingContribution.z
...
#line 366
  lt r10.w, cb1[r9.w + 46].x, r6.z

#line 369
  and r10.w, r10.w, l(1)  // r10.w <- cascadeIndex

#line 366
  iadd r12.xy, r9.wwww, l(1, 2, 0, 0)
  lt r11.w, cb1[r12.x + 46].x, r6.z

#line 369
  movc r10.w, r11.w, l(2), r10.w

#line 366
  lt r11.w, cb1[r12.y + 46].x, r6.z

#line 369
  movc r10.w, r11.w, l(3), r10.w

#line 287
  add r12.x, -r8.w, l(1.000000)
  max r12.x, r12.x, l(0.000000)  // r12.x <- normalOffsetScale
  mul r12.x, r1.w, r12.x

#line 373
  mov r13.x, r5.w
  mov r13.yz, r6.xxyx
  mad r4.xyz, r12.xxxx, r5.xyzx, r13.xyzx  // r4.x <- shadowPosition.x; r4.y <- shadowPosition.y; r4.z <- shadowPosition.z

#line 280
  iadd r9.w, r9.w, r10.w
  ishl r12.x, r9.w, l(2)
  dp4 r13.x, r4.xyzw, cb1[r12.x + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r12.x + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r12.y, r4.xyzw, cb1[r12.x + 30].xyzw  // r12.y <- shadowPosition.z
  dp4 r12.z, r4.xyzw, cb1[r12.x + 31].xyzw  // r12.z <- shadowPosition.w
  add r13.z, r12.y, -cb1[44].x  // r13.z <- shadowPosition.z
  div r12.yzw, r13.xxyz, r12.zzzz  // r12.y <- shadowPosition.x; r12.z <- shadowPosition.y; r12.w <- shadowPosition.z

#line 216
  mad r12.yz, r12.yyzy, cb1[27].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
  round_ni r13.xy, r12.yzyy  // r13.x <- base_uv.x; r13.y <- base_uv.y
  add r12.yz, r12.yyzy, -r13.xxyx  // r12.y <- s; r12.z <- t
  add r13.xy, r13.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  mul r13.xy, r13.xyxx, cb1[27].zwzz

#line 229
  mad r13.zw, -r12.zzzy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r13.w <- uw0; r13.z <- vw0
  mad r14.xy, r12.yzyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r14.x <- uw2; r14.y <- vw2
  mad r14.zw, -r12.yyyz, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r14.zw, r14.zzzw, r13.wwwz
  add r15.xy, r12.yzyy, l(3.000000, 3.000000, 0.000000, 0.000000)
  div r12.yz, r12.yyzy, r14.xxyx
  ...
  add r15.xy, r12.yzyy, l(2.000000, 2.000000, 0.000000, 0.000000)  // r15.x <- u2; r15.y <- v2
  mul r12.y, r13.z, r13.w
  mad r17.xyzw, r16.xwzw, cb1[27].zwzw, r13.xyxy

#line 196
  sample_c r12.z, r17.xyxx, t6.xxxx, s0, r12.w  // r12.z <- <SampleTextureAndCompare_id96 return value>

#line 238
  mul r14.zw, r13.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 196
  sample_c r17.x, r17.zwzz, t6.xxxx, s0, r12.w  // r17.x <- <SampleTextureAndCompare_id96 return value>

#line 236
  mul r14.z, r14.z, r17.x
  mad r12.y, r12.y, r12.z, r14.z  // r12.y <- shadow
...
#line 237
  mad r12.y, r13.z, r12.z, r12.y
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 196
  sample_c r12.z, r18.xyxx, t6.xxxx, s0, r12.w

#line 238
  mad r12.y, r14.w, r12.z, r12.y

#line 196
  sample_c r12.z, r18.zwzz, t6.xxxx, s0, r12.w

#line 239
  mad r12.y, r12.z, l(49.000000), r12.y

#line 242
  mul r14.zw, r14.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 196
  sample_c r12.z, r17.zwzz, t6.xxxx, s0, r12.w

#line 240
  mad r12.y, r14.z, r12.z, r12.y
  mov r16.y, r15.y
  mad r16.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 196
  sample_c r12.z, r16.xyxx, t6.xxxx, s0, r12.w

#line 241
  mad r12.y, r13.w, r12.z, r12.y

#line 196
  sample_c r12.z, r16.zwzz, t6.xxxx, s0, r12.w
...
#line 196
  sample_c r12.w, r13.xyxx, t6.xxxx, s0, r12.w  // r12.w <- <SampleTextureAndCompare_id96 return value>

#line 243
  mad r12.y, r12.z, r12.w, r12.y
  mul r12.z, r12.y, l(0.006944)  // r12.z <- shadow

#line 378
  iadd r12.w, r9.w, l(-1)
  add r12.w, -cb1[r12.w + 46].x, cb1[r9.w + 46].x
  movc r10.w, r10.w, r12.w, cb1[r9.w + 46].x  // r10.w <- splitSize
  add r9.w, -r6.z, cb1[r9.w + 46].x
  div r9.w, r9.w, r10.w  // r9.w <- splitDist
  lt r10.w, r9.w, l(0.200000)

#line 280
  iadd r12.x, r12.x, l(4)
  dp4 r13.x, r4.xyzw, cb1[r12.x + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r12.x + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r12.w, r4.xyzw, cb1[r12.x + 30].xyzw  // r12.w <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r12.x + 31].xyzw  // r4.x <- shadowPosition.w
...
#line 216
  ...
  round_ni r12.xw, r4.xxxy  // r12.x <- base_uv.x; r12.w <- base_uv.y
  add r4.xy, r4.xyxx, -r12.xwxx  // r4.x <- s; r4.y <- t
  add r12.xw, r12.xxxw, l(-0.500000, 0.000000, 0.000000, -0.500000)
  mul r12.xw, r12.xxxw, cb1[27].zzzw
...
#line 229
  ...
  mad r16.xyzw, r15.xwzw, cb1[27].zwzw, r12.xwxw

#line 196
  sample_c r4.x, r16.xyxx, t6.xxxx, s0, r4.z  // r4.x <- <SampleTextureAndCompare_id96 return value>
  sample_c r4.y, r16.zwzz, t6.xxxx, s0, r4.z  // r4.y <- <SampleTextureAndCompare_id96 return value>

#line 240
  mov r14.zw, r15.wwwy
  mad r16.xyzw, r14.xzxw, cb1[27].zwzw, r12.xwxw

#line 196
  sample_c r14.z, r16.xyxx, t6.xxxx, s0, r4.z  // r14.z <- <SampleTextureAndCompare_id96 return value>

#line 239
  mad r17.xyzw, r15.xyzy, cb1[27].zwzw, r12.xwxw

#line 196
  sample_c r14.w, r17.xyxx, t6.xxxx, s0, r4.z  // r14.w <- <SampleTextureAndCompare_id96 return value>
  sample_c r15.w, r17.zwzz, t6.xxxx, s0, r4.z  // r15.w <- <SampleTextureAndCompare_id96 return value>
  sample_c r16.x, r16.zwzz, t6.xxxx, s0, r4.z  // r16.x <- <SampleTextureAndCompare_id96 return value>
...
#line 196
  sample_c r15.x, r17.xyxx, t6.xxxx, s0, r4.z  // r15.x <- <SampleTextureAndCompare_id96 return value>
  sample_c r15.y, r17.zwzz, t6.xxxx, s0, r4.z  // r15.y <- <SampleTextureAndCompare_id96 return value>

#line 243
  mad r12.xw, r14.xxxy, cb1[27].zzzw, r12.xxxw

#line 196
  sample_c r4.z, r12.xwxx, t6.xxxx, s0, r4.z  // r4.z <- <SampleTextureAndCompare_id96 return value>
...
#line 235
      mul r10.w, r13.x, r13.y
      mul r4.y, r13.x, r4.y
      mul r4.y, r4.y, l(7.000000)
      mad r4.x, r10.w, r4.x, r4.y  // r4.x <- shadow

#line 241
      mul r12.xw, r13.xxxy, r13.zzzw

#line 237
      mad r4.x, r12.x, r14.z, r4.x
      mul r4.y, r13.y, r14.w
      mad r4.x, r4.y, l(7.000000), r4.x
      mad r4.x, r15.w, l(49.000000), r4.x
      mul r4.y, r13.z, r16.x
      mad r4.x, r4.y, l(7.000000), r4.x
...
#line 389
      mad r4.y, r12.y, l(0.006944), -r4.x
      mad r12.z, r9.w, r4.y, r4.x
    endif 
  endif   // r12.z <- shadow

#line 491
  mul r4.xyz, r12.zzzz, cb1[26].xyzx
...
#line 538
  ...
  rsq r7.x, r7.x
  mul r12.xyz, r7.xxxx, r12.xyzx  // r12.x <- streams.H_id68.x; r12.y <- streams.H_id68.y; r12.z <- streams.H_id68.z
  dp3 r7.x, -cb1[25].xyzx, r12.xyzx
...
#line 269
  ...
  mul r9.w, r9.w, r9.w
  mul r7.x, r7.x, r9.w
  mad r13.xyz, r13.xyzx, r7.xxxx, r10.xyzx  // r13.x <- <FresnelSchlick_id155 return value>.x; r13.y <- <FresnelSchlick_id155 return value>.y; r13.z <- <FresnelSchlick_id155 return value>.z

#line 265
  mad r7.x, r8.w, l(0.500000), l(0.500000)
  div r7.x, r8.w, r7.x  // r7.x <- <VisibilityhSchlickGGX_id173 return value>
  mad r9.w, r3.w, l(0.500000), l(0.500000)
  div r9.w, r3.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id173 return value>

#line 316
  mul r7.x, r7.x, r9.w
  mul r8.w, r3.w, r8.w
  div r7.x, r7.x, r8.w  // r7.x <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 354
mul r0.xyz, r0.xxxx, r3.xyzx  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.z
...
#line 690
mad r0.xyz, r2.xyzx, cb1[50].xyzx, r0.xyzx  // r0.x <- environmentLightingContribution.x; r0.y <- environmentLightingContribution.y; r0.z <- environmentLightingContribution.z
...
static const float PI_id192 = 3.14159265358979323846;
...
float NormalDistributionGGX_id189(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id192 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id192 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
{
    return Texture_id181.Sample(Sampler_id173, streams.TexCoord_id148 * scale_id183 + offset_id184).rgba;
}
...
void Compute_id407(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id192 + environmentLightingContribution;
...
{
    streams.matSpecular_id49 = Compute_id236(streams).rgb;
}

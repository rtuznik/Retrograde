...
@R    Sampler_id99 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Texture_id168 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
@R    Texture_id168 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id168 => Material.SpecularMap [Stage: Pixel, Slot: (1-1)]
...
//
#line 670 "D:\XenkoProjects\Retrograde\Retrograde\Retrograde.Windows\log\shader_XenkoEditorForwardShadingEffect_064da9168d9c68815837ffb51a81109b.hlsl"
...
@G    Pixel => f1f70dd7e711d5847fc7924731e47913
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id170;                // Offset:   20 Size:     8
//   float2 offset_id171;               // Offset:   32 Size:     8
//   float constantFloat_id173;         // Offset:   40 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 699 "D:\XenkoProjects\Retrograde\Retrograde\Retrograde.Windows\log\shader_XenkoEditorForwardShadingEffect_064da9168d9c68815837ffb51a81109b.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s0  // r2.x <- <Compute_id229 return value>.x; r2.y <- <Compute_id229 return value>.y; r2.z <- <Compute_id229 return value>.z; r2.w <- <Compute_id229 return value>.w

#line 472
mad r3.xy, v3.xyxx, cb0[1].yzyy, cb0[2].xyxx
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t1.xyzw, s0  // r3.x <- <Compute_id233 return value>.x; r3.y <- <Compute_id233 return value>.y; r3.z <- <Compute_id233 return value>.z
...
#line 437
and r3.w, r4.y, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id204 return value>
...
#line 321
  ld_indexable(buffer)(uint,uint,uint,uint) r8.w, r4.zzzz, t3.yzwx  // r8.w <- realLightIndex
  iadd r4.z, r4.z, l(1)  // r4.z <- streams.lightIndex_id84
  ishl r10.w, r8.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r11.xyzw, r10.wwww, t4.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  bfi r8.w, l(31), l(1), r8.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r8.wwww, t4.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 204
  ...
  mul r7.y, r7.y, r10.w
  mad r13.xyz, r13.xyzx, r7.yyyy, r9.xyzx  // r13.x <- <FresnelSchlick_id152 return value>.x; r13.y <- <FresnelSchlick_id152 return value>.y; r13.z <- <FresnelSchlick_id152 return value>.z

#line 199
  mul r7.y, r9.w, l(0.500000)  // r7.y <- k
  mad r10.w, -r9.w, l(0.500000), l(1.000000)
  mad r11.w, r8.w, r10.w, r7.y
  div r11.w, r8.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id170 return value>
  mad r7.y, r4.w, r10.w, r7.y
  div r7.y, r4.w, r7.y  // r7.y <- <VisibilityhSchlickGGX_id170 return value>

#line 235
  mul r7.y, r7.y, r11.w
  mul r8.w, r4.w, r8.w
  div r7.y, r7.y, r8.w  // r7.y <- <VisibilitySmithSchlickGGX_id172 return value>
...
#line 230
  ...
  div r7.x, r8.w, r7.x  // r7.x <- <NormalDistributionGGX_id186 return value>
...
#line 398
ushr r3.w, r4.y, l(16)  // r3.w <- <GetMaxLightCount_id213 return value>
...
#line 290
  ld_indexable(buffer)(uint,uint,uint,uint) r8.w, r6.wwww, t3.yzwx  // r8.w <- realLightIndex
  iadd r6.w, r6.w, l(1)  // r6.w <- streams.lightIndex_id84
  ishl r9.y, r8.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r9.yyyy, t5.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z
...
#line 224
  mul r8.w, r8.w, r9.y  // r8.w <- attenuation
  mul r13.xyz, r8.wwww, r15.xyzx  // r13.x <- streams.lightColor_id39.x; r13.y <- streams.lightColor_id39.y; r13.z <- streams.lightColor_id39.z

#line 388
  dp3 r8.w, r5.xyzx, r12.xyzx
  max r8.w, r8.w, l(0.000100)  // r8.w <- streams.NdotL_id43
  mul r13.xyz, r8.wwww, r13.xyzx  // r13.x <- streams.lightColorNdotL_id40.x; r13.y <- streams.lightColorNdotL_id40.y; r13.z <- streams.lightColorNdotL_id40.z
...
#line 204
  ...
  mul r9.w, r9.w, r9.w
  mul r9.y, r9.w, r9.y
  mad r14.xyz, r14.xyzx, r9.yyyy, r8.xyzx  // r14.x <- <FresnelSchlick_id152 return value>.x; r14.y <- <FresnelSchlick_id152 return value>.y; r14.z <- <FresnelSchlick_id152 return value>.z

#line 199
  mul r9.y, r9.x, l(0.500000)  // r9.y <- k
  mad r9.w, -r9.x, l(0.500000), l(1.000000)
  mad r10.w, r8.w, r9.w, r9.y
  div r10.w, r8.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id170 return value>
  mad r9.y, r9.z, r9.w, r9.y
  div r9.y, r9.z, r9.y  // r9.y <- <VisibilityhSchlickGGX_id170 return value>

#line 235
  mul r9.y, r9.y, r10.w
  mul r8.w, r9.z, r8.w
  div r8.w, r9.y, r8.w  // r8.w <- <VisibilitySmithSchlickGGX_id172 return value>
...
#line 230
  ...
  mul r7.x, r7.x, r7.x
  mul r7.x, r7.x, l(3.141593)
  div r7.x, r9.y, r7.x  // r7.x <- <NormalDistributionGGX_id186 return value>
...
#line 204
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r13.xyz, r13.xyzx, r5.wwww, r7.xyzx  // r13.x <- <FresnelSchlick_id152 return value>.x; r13.y <- <FresnelSchlick_id152 return value>.y; r13.z <- <FresnelSchlick_id152 return value>.z

#line 199
  mul r5.w, r8.x, l(0.500000)  // r5.w <- k
  mad r7.w, -r8.x, l(0.500000), l(1.000000)
  mad r8.y, r6.w, r7.w, r5.w
  div r8.y, r6.w, r8.y  // r8.y <- <VisibilityhSchlickGGX_id170 return value>
  mad r5.w, r8.z, r7.w, r5.w
  div r5.w, r8.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id170 return value>

#line 235
  mul r5.w, r5.w, r8.y
  mul r6.w, r8.z, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id172 return value>
...
#line 230
  ...
  div r5.x, r6.w, r5.x  // r5.x <- <NormalDistributionGGX_id186 return value>
...
mad r0.xyz, r3.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id187 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id187 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id187 return value>.z

#line 354
mul r0.xyz, r0.xyzx, cb1[41].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id374 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id374 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id374 return value>.z
...
float VisibilityhSchlickGGX_id170(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
...
float NormalDistributionGGX_id186(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    return alphaR2 / (PI_id179 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
float VisibilitySmithSchlickGGX_id172(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id170(alphaR, nDotL) * VisibilityhSchlickGGX_id170(alphaR, nDotV) / (nDotL * nDotV);
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id187(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id186(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id266(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id172(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id237(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id158(f0, streams.LdotH_id70);
}
...
float3 ComputeEnvironmentLightContribution_id374(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id187(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
float3 ComputeEnvironmentLightContribution_id325(inout PS_STREAMS streams)
{
...
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id237(streams, specularColor);
    float geometricShadowing = Compute_id266(streams);
    float normalDistribution = Compute_id295(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeDirectLightContribution_id324(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
...
float4 Compute_id233(inout PS_STREAMS streams)
{
    return Texture_id168.Sample(Sampler_id99, streams.TexCoord_id100 * scale_id170 + offset_id171).rgba;
}
float4 Compute_id231()
{
    return float4(constantFloat_id104, constantFloat_id104, constantFloat_id104, constantFloat_id104);
}
float4 Compute_id229(inout PS_STREAMS streams)
{
...
void Compute_id409(inout PS_STREAMS streams)
{
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id324(streams);
            }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id325(streams);
        }
...
{
    streams.matSpecularIntensity_id50 = Compute_id235().r;
}
void Compute_id389(inout PS_STREAMS streams)
{
    streams.matSpecular_id49 = Compute_id233(streams).rgb;
}
void Compute_id384(inout PS_STREAMS streams)
{
    float glossiness = Compute_id231().r;
    streams.matGlossiness_id48 = glossiness;
}
void Compute_id379(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id229(streams);
